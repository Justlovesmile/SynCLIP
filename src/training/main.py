...
from training.synclip import SynCLIP
import numpy as np
import torch
...
from training.utils import freeze_parameters, build_vfm
...
def main(args):
    ...
    # swanlab
    if args.swanlab and is_master(args, local=args.log_local):
        import swanlab
        args.writer = swanlab.init(
            project="SynCLIP-Pretrain",
            ...
            config=dict(
                ...
                loss_semantic_weight=args.loss_semantic_weight,
    ...
    if args.use_vfm:
        vfm_model = build_vfm(args.use_vfm, weight=args.vfm_ckpt)
