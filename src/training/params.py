...
def parse_args(args):
    ...
    parser.add_argument(
        "--vfm_ckpt",
        type=str,
        default="./ckpts/DINOv3-ViT-LVD-1689M/dinov3_vitb16_pretrain_lvd1689m-73cec8be.pth",
    )
    parser.add_argument(
        "--swanlab",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=int, 
        default=200, 
        help='Steps between similarity visualizations'
    )
    parser.add_argument(
        "--semantic-type",
        type=str,
        choices=["definition", "synonym", "translation", "semantic", "all", "label"],
        default="semantic",
    )
    parser.add_argument(
        "--semantic-path",
        type=str,
        default='./data/coco/Annotations/synonyms_lvis_coco.json'
    )
    parser.add_argument(
        "--filelabel-path",
        type=str,
        default='./data/coco/Annotations/lvis_coco_categories_train2017.json'
    )
    parser.add_argument(
        "--sem-mode",
        choices=["qq", "kk", "vv", "csa", "all"],
        default="csa",
        help="Choosing an attention mode for training and inference"
    )
    parser.add_argument(
        "--sem-loss",
        choices=["mse", "l2", "kl", "js", "cos", "huber", "focalmse", "huber_kl", "mse_kl", "huber_cos", "mse_cos"],
        default="huber_kl",
        help="semantic alignment loss function"
    )
    parser.add_argument(
        "--random-label",
        action="store_true",
    ...
    parser.add_argument(
        "--dataset-type",
        choices=['proposals_distill', "region_clip", "grid_distill", "knn_grid_distill", "coco_caption", "semantic_grid_distill", "semantic_proposals_distill"],
