...
def _make_dinov3_vit(
    *,
    ...
    pos_embed_rope_min_period: Optional[float] = None, #float | None = None,
    pos_embed_rope_max_period: Optional[float] = None, #float | None = None,
    pos_embed_rope_normalize_coords: str = "separate",
    pos_embed_rope_shift_coords: Optional[float] = None, #float | None = None,
    pos_embed_rope_jitter_coords: Optional[float] = None, #float | None = None,
    pos_embed_rope_rescale_coords: Optional[float] = None, #float | None = None,
    ...
    layerscale_init: Optional[float] = None, #float | None = None,
