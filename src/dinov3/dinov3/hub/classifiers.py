...
def _make_dinov3_linear_classification_head(
    *,
    ...
    classifier_weights: Union[ClassifierWeights, str] = ClassifierWeights.IMAGENET1K, #ClassifierWeights | str = ClassifierWeights.IMAGENET1K,
...
def _make_dinov3_linear_classifier(
    *,
    ...
    pretrained: bool = True,
    classifier_weights: Union[ClassifierWeights, str] = ClassifierWeights.IMAGENET1K, #ClassifierWeights | str = ClassifierWeights.IMAGENET1K,
    backbone_weights: Union[BackboneWeights, str] = BackboneWeights.LVD1689M, #BackboneWeights | str = BackboneWeights.LVD1689M,
    check_hash: bool = False,
    **kwargs,
):
...
def dinov3_vit7b16_lc(
    *,
    pretrained: bool = True,
    weights: Union[ClassifierWeights, str] = ClassifierWeights.IMAGENET1K, #ClassifierWeights | str = ClassifierWeights.IMAGENET1K,
    backbone_weights: Union[BackboneWeights, str] = BackboneWeights.LVD1689M, #BackboneWeights | str = BackboneWeights.LVD1689M,
    check_hash: bool = False,
    **kwargs,
):
