...
class CustomCLIP(nn.Module):
    ...
    def encode_dense(self, image, normalize: bool = False, keep_shape=False, mode="only_v"):
    ...
    def encode_pseudo_boxes(self, image, 
                            normed_boxes, 
                            normalize: bool = False,
                            mode="qq",
                            ):
        if 'distill' in mode or mode=="sanity_check":
            box_features, clip_dense_feats = self.visual.extract_roi_features(image, normed_boxes, mode=mode)
            if normalize:
    ...
    def encode_masks(self, image, masks, normalize=True, mode="qq"):
