...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            vlm_temperature=90.0,
            alpha=0.1,
            beta=0.6,       # a larger beta can significantly increase APr, e.g., setting beta=0.6 or 0.8
            class_embed=
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='./data/coco/Annotations/lvis_v1_train_seen_1203_cat.json',
    ...
    test=dict(
        ...
        img_prefix='./data/coco/Images/',
        pipeline=test_pipeline))
evaluation = dict(interval=6, metric=['segm'])
