_base_ = "../ov_lvis/fvit_vitl14_upsample_fpn_bs64_4x_ovlvis_eva_synclip.py"
num_classes = 365
model = dict(
    roi_head=dict(
        bbox_head=dict(
            ...
            fixed_temperature=60.0,
            vlm_temperature=120,
            alpha=0.5,
            class_embed='datasets/embeddings/objects365v1_transfer_background_evaclip_vitl14x336.pt',
...
data_root = '/mnt/DataShare/_Public_Datasets_/Detection/Objects365-v1/2019-08-02/'
...
data = dict(
    val=dict(
        ...
        classes=classes,
        type=dataset_type,
        ann_file=data_root + 'objects365_reorder_val_info.json',
